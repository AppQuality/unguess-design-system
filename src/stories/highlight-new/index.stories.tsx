...
const Transcript = ({ onSelectionButtonClick, ...args }: StoryArgs) => {
  ...
  return (
    <>
      ...
      <HighlightContextProvider
        onSave={(editor, observations) =>
          console.log("Triggered Save", editor, observations)
        }
      >
        <Transcript {...args} search={debauncedValue} />
      </HighlightContextProvider>
    </>
  );
};
